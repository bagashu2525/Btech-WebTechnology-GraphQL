...
import cors from "cors"; //cors is used to allow cross-origin requests, it is a middleware
...
const server = new ApolloServer({ typeDefs, resolvers }); //apolloserver is used to create a graphql server
...
async function startServer() {
  ...
  app.listen(4000, () => {
    console.log("Server is running at http://localhost:4000/graphql port");
  });
}
